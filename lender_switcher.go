...
func createBorrowerDetails(stub shim.ChaincodeStubInterface) error {
	...
	columnSevenTableOneDef := shim.ColumnDefinition{Name: "phone", Type: shim.ColumnDefinition_STRING, Key: true}
	...
	columnThirteenTableOneDef := shim.ColumnDefinition{Name: "productName", Type: shim.ColumnDefinition_STRING, Key: true}
