...
func createTableOne(stub shim.ChaincodeStubInterface) error {
	...
	columnOneTableOneDef := shim.ColumnDefinition{Name: "ffId", Type: shim.ColumnDefinition_STRING, Key: true}
	columnTwoTableOneDef := shim.ColumnDefinition{Name: "title", Type: shim.ColumnDefinition_STRING, Key: false}
	columnThreeTableOneDef := shim.ColumnDefinition{Name: "gender", Type: shim.ColumnDefinition_STRING, Key: false}
